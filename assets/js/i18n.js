var I18N = {
  fr: {
    "seo_title": "LOMPO Ibrahim | Géomaticien & expert SIG à Ouagadougou - Burkina Faso",
    "seo_description": "Portfolio de LOMPO Ibrahim, géomaticien et développeur WebSIG à Ouagadougou (Burkina Faso) : télédétection, SIG, machine learning, plugins QGIS (18 515+ téléchargements), plateformes WebGIS et recherche appliquée.",
    "lang_aria": "Changer de langue",
    "header_role": "Géomaticien - SIG, WebSIG & ML",
    "contact": "Contact",
    "deco_recherche": "Recherche",
    "deco_plugins": "Plugins QGIS",
    "deco_outils": "5 outils",
    "deco_downloads": "18 515+ téléchargements cumulés - 116 avis 5/5",
    "role_main": "Géomaticien - SIG, Télédétection, WebSIG & ML",
    "location": "Ouagadougou, Burkina Faso",
    "bio": "Géomaticien et développeur WebSIG spécialisé en télédétection, analyse spatiale, automatisation SIG et machine learning, avec une expertise en modélisation et prédiction de phénomènes spatiaux et en développement d'outils géomatiques sur mesure.",
    "dl_cv": "Télécharger le CV",
    "stat_plugins": "Plugins QGIS",
    "stat_downloads": "Téléchargements",
    "stat_avis": "Avis 5★",
    "cta_title": "Un projet en tête ? Parlons-en.",
    "cta_start": "Démarrer",
    ...
    "desc_ml": "Transforme QGIS en station de travail de pointe en machine learning spatial ; automatise les classifications d'occupation du sol.",
    ...
    "expertise": "Expertise",
    "skills": "Compétences",
    "chip_teledetection": "Télédétection",
    "chip_sigavance": "SIG avancé",
    "chip_collecte": "Collecte de données terrain",
    "chip_ml": "Machine Learning",
    "chip_automatisation": "Automatisation",
    "chip_gee": "Google Earth Engine",
    "chip_bdd": "Base de données",
    "chip_geomarketing": "Géomarketing",
    "chip_ia": "Intelligence artificielle",
    "tools": "Outils & logiciels",
    "cloud": "Cloud & langages",
    "chip_sql": "SQL / Bases de données",
    "webdev": "Développement web",
    "chip_cartoweb": "Cartographie web (Leaflet / MapLibre)",
    "certs": "Certifications & formations",
    "cert_group_gis": "SIG, télédétection & géomatique",
    "cert_group_prog": "Programmation, cloud & IA",
    "cert_group_env": "Environnement & foncier",
    "cert_group_proj": "Gestion de projet & engagement humanitaire",
    "cert_group_lang": "Langues",
    "cert_drone": "Télépilote, sous-catégories A1 et A3 - DGAC",
    "cert_expire_drone": "Expire avr. 2031 - N° FRA-RP-000000145689",
    "cert_dea": "Digital Earth Africa - Urbanisation",
    "cert_expire_dea": "Expire avr. 2036 - Apprentissage automatique, télédétection",
    "cert_cntig": "Booster son employabilité par les sciences de la géoinformation - CNTIG (Côte d'Ivoire)",
    "cert_fao": "Surveillance des forêts et des terres pour l'action climatique (SEPAL) - FAO",
    "cert_dww": "Développement web niveau débutant - IFDD",
    "cert_ia": "Découvrir les bases de l'IA - Microsoft",
    "cert_py_udemy": "Formation complète en Python - Udemy",
    "cert_env1": "Droit et protection de l'environnement - Univ. Senghor / OIF",
    "cert_env2": "L'économie circulaire - Candriam",
    "cert_env3": "Les villes et les changements climatiques - UNITAR",
    "cert_env4": "Foncier et développement - AFD",
    "cert_pm1": "Introduction à la gestion du cycle de projet - ITCILO",
    "cert_pm2": "Soutien initial aux survivant(e)s de VBG - UNICEF",
    "cert_pm5": "Gestion de projet complet - Cursa",
    "cert_pm6": "Le déplacement lié aux catastrophes - Humanitarian Leadership Academy",
    "cert_pm7": "Inégalités de genre dans le secteur entrepreneurial - AFD",
    "cert_pm8": "Référentiel des compétences de l'entrepreneur - Univ. Joseph Ki-Zerbo",
    "cert_lang1": "Anglais élémentaire A2 - Cursa",
    "languages_h3": "Langues",
    "chip_lang_fr": "Français - langue maternelle",
    "chip_lang_en": "Anglais - intermédiaire",
    "parcours": "Parcours",
  ...
  en: {
    "seo_title": "LOMPO Ibrahim | GIS Expert & Geomatics Engineer in Ouagadougou - Burkina Faso",
    "seo_description": "Portfolio of LOMPO Ibrahim, GIS analyst and WebSIG developer in Ouagadougou (Burkina Faso): remote sensing, GIS, machine learning, QGIS plugins (18,515+ downloads), WebGIS platforms and applied research.",
    "lang_aria": "Change language",
    "header_role": "Geomatics Engineer - GIS, WebSIG & ML",
    "contact": "Contact",
    "deco_recherche": "Research",
    "deco_plugins": "QGIS Plugins",
    "deco_outils": "5 tools",
    "deco_downloads": "18,515+ cumulative downloads - 116 five-star reviews",
    "role_main": "Geomatics Engineer - GIS, Remote Sensing, WebSIG & ML",
    "location": "Ouagadougou, Burkina Faso",
    "bio": "Geomatics engineer and WebSIG developer specialized in remote sensing, spatial analysis, GIS automation and machine learning, with expertise in modeling and predicting spatial phenomena and building custom geomatics tools.",
    "dl_cv": "Download CV",
    "stat_plugins": "QGIS Plugins",
    ...
    "desc_ml": "Turns QGIS into a state-of-the-art spatial machine learning workstation; automates land cover classifications.",
    ...
    "expertise": "Expertise",
    "skills": "Skills",
    "chip_teledetection": "Remote Sensing",
    "chip_sigavance": "Advanced GIS",
    "chip_collecte": "Field Data Collection",
    "chip_ml": "Machine Learning",
    "chip_automatisation": "Automation",
    "chip_gee": "Google Earth Engine",
    "chip_bdd": "Databases",
    "chip_geomarketing": "Geomarketing",
    "chip_ia": "Artificial Intelligence",
    "tools": "Tools & software",
    "cloud": "Cloud & languages",
    "chip_sql": "SQL / Databases",
    "webdev": "Web development",
    "chip_cartoweb": "Web mapping (Leaflet / MapLibre)",
    "certs": "Certifications & training",
    "cert_group_gis": "GIS, remote sensing & geomatics",
    "cert_group_prog": "Programming, cloud & AI",
    "cert_group_env": "Environment & land tenure",
    "cert_group_proj": "Project management & humanitarian engagement",
    "cert_group_lang": "Languages",
    "cert_drone": "Drone pilot, subcategories A1 and A3 - DGAC",
    "cert_expire_drone": "Expires Apr. 2031 - No. FRA-RP-000000145689",
    "cert_dea": "Digital Earth Africa - Urbanization",
    "cert_expire_dea": "Expires Apr. 2036 - Machine learning, remote sensing",
    "cert_cntig": "Boosting employability through geoinformation sciences - CNTIG (Côte d'Ivoire)",
    "cert_fao": "Forest and land monitoring for climate action (SEPAL) - FAO",
    "cert_dww": "Beginner Web Development - IFDD",
    "cert_ia": "Discover the Basics of AI - Microsoft",
    "cert_py_udemy": "Complete Python Training - Udemy",
    "cert_env1": "Environmental Law and Protection - Univ. Senghor / OIF",
    "cert_env2": "The Circular Economy - Candriam",
    "cert_env3": "Cities and Climate Change - UNITAR",
    "cert_env4": "Land Tenure and Development - AFD",
    "cert_pm1": "Introduction to Project Cycle Management - ITCILO",
    "cert_pm2": "Initial Support for GBV Survivors - UNICEF",
    "cert_pm5": "Complete Project Management - Cursa",
    "cert_pm6": "Disaster Displacement - Humanitarian Leadership Academy",
    "cert_pm7": "Gender Inequalities in Entrepreneurship - AFD",
    "cert_pm8": "Entrepreneurship Skills Framework - Univ. Joseph Ki-Zerbo",
    "cert_lang1": "Elementary English A2 - Cursa",
    "languages_h3": "Languages",
    "chip_lang_fr": "French - native",
    "chip_lang_en": "English - intermediate",
    "parcours": "Career",
...
function applyLang(lang) {
  ...
  Object.keys(metas).forEach(function (sel) {
    ...
    if (m) m.setAttribute('content', dict[metas[sel]]);
  });
...
function toggleLang() {
  ...
  if (!cur || !I18N[cur]) cur = detectLang();
